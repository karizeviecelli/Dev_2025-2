...
public class UsuarioService {
    ...
    public boolean verificaLogin(UsuarioDto dadoslogin){


        Optional<UsuarioModel> usuarioOP = repository.findByLoginAndSenha(dadoslogin.getLogin(),dadoslogin.getSenha());
